(function(){ var widget_id = 'VxBMoEuOht';var d=document;var w=window;function l(){
...
(function (d, w, c) { (w[c] = w[c] || []).push(function() { try { w.yaCounter39185230 = new Ya.Metrika({ id:39185230, clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true, ecommerce:"dataLayer" }); } catch(e) { } }); var n = d.getElementsByTagName("script")[0], s = d.createElement("script"), f = function () { n.parentNode.insertBefore(s, n); }; s.type = "text/javascript"; s.async = true; s.src = "https://mc.yandex.ru/metrika/watch.js"; if (w.opera == "[object Opera]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); } })(document, window, "yandex_metrika_callbacks");
/* ===========================================================
 *
...
jQuery(document).ready(function($) {
    ...
    // widget title in filter
    
	$('.yit-wcan-select-open').each(function() {
		$(this).append($(this).prev('.widgettitle').text());
    });
  ...
  // select
    ...
    // percent sale
    $(function(){
        var salePrice = parseInt($('.price del .woocommerce-Price-amount.amount').text());
        var regularPrice = parseInt($('.price ins .woocommerce-Price-amount.amount').text());
        var percentPrice = "sale " + parseInt(((salePrice - regularPrice) / salePrice) * 100 ) + "%";
            $('.onsale').html(percentPrice);
    });
